...
import { UserGroupIcon, AcademicCapIcon, BuildingLibraryIcon, ChartBarIcon } from "@heroicons/react/24/outline"
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      const [prof, eleves, cls, profList, eleveList, activities] = await Promise.all([
