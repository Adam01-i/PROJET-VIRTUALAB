          ...
          >
            <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
              <CardHeader className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-t-lg">
                ...
                <p className="text-sm text-blue-100">Posez vos questions sur la chimie et les expériences !</p>
              </CardHeader>
              ...
              <CardContent className="h-80 overflow-y-auto p-4 space-y-4">
                {messages.length === 0 && (
                  <div className="text-center text-gray-500 mt-8">
                    ...
                    <p className="text-sm">
                      Bonjour ! Je suis votre assistant en chimie. Posez-moi des questions sur les expériences, les
                      molécules, les réactions chimiques, etc.
                    </p>
                  </div>
                )}
