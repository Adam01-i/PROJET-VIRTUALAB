...
export default function ExperienceDetailView({
      ...
      <div className="fixed inset-0 z-50 bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-900 flex flex-col">
        <div className="flex-1 flex flex-col space-y-6">
          ...
          <div className="flex-1 bg-white/5 backdrop-blur-lg rounded-xl  border border-white/10">
            ...
            <div className="relative h-[calc(100%-4rem)] bg-indigo-900/50 rounded-lg flex items-center justify-center">
              {!isRunning ? (
                <div className="text-center text-purple-200">
                  <Flask size={48} className="mx-auto mb-4" />
                  <p className="text-lg font-medium">
                    Cliquez sur Démarrer pour commencer l'expérience
                  </p>
  ...
  return (
    <div className="flex flex-co1 h-full">
      <div className="flex-1 grid grid-cols-4 gap-6">
        ...
        <div className="col-span-3 space-y-6">
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 h-[830px]">
            ...
            <div className="relative h-[670px] bg-indigo-900/50 rounded-lg flex items-center justify-center">
              {!isRunning ? (
                <div className="text-center text-purple-200">
                  <Flask size={48} className="mx-auto mb-4" />
                  <p className="text-lg font-medium">
        ...
        <div className="col-span-1 space-y-6 ">
          {/* Explications + Résultats attendus */}
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {experience.objectifs.map((obj, index) => (
                    <li
                      key={index}
                      className="flex items-start space-x-2 text-purple-200"
                    >
