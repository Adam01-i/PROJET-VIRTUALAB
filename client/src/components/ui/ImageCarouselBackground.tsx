...
function ImageCarouselBackground({ images }: { images: string[] }) {
  const [index, setIndex] = useState(0);

  // Remettre index à 0 quand les images changent
  useEffect(() => {
    setIndex(0);  // 🔁 Important : reset
  }, [images]);
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden z-20 leading-none">
        ...
        >
          <path fill="#ffffff" d="M0,224 C480,320 960,128 1440,224 L1440,320 L0,320 Z" />
        </svg>
      </div>
